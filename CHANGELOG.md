...
## [0.6.0] 2026-02-27
### Added
- Option in `make_samplelists_from_manifest.pl` to include tumour type from a metadata file

### Changed
- Updated CI/CD template to use ref 0.4.2
- Updated build to inherit from MAF 'latest'
